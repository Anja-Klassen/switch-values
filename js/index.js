...
- [ ] Make sure that when the switch button is clicked, the values of the two 
input fields are being switched
...
switchButton.addEventListener("click", () => {
  ...
  const newFirstInput = oldSecondInput;
  const newSecondInput = oldFirstInput;
